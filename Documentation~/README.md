# com.thelegends.facebook.manager


A com.thelegends.facebook.manager package for the [Unity](https://unity.com/) Game Engine.
...
- Add the `com.thelegends.facebook.manager` package
